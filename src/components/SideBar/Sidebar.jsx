    ...
    <div className="w-64 bg-gray-800 text-white p-6 flex flex-col space-y-6 h-full">
      ...
      <nav className="flex flex-col space-y-4">
        <button
          ...
          className="flex items-center space-x-3 text-gray-300 hover:text-white p-2 rounded-lg hover:bg-gray-700 transition-colors duration-200"
        >
          <HomeIcon className="w-6 h-6" />
          <span>Inicio</span>
        </button>
        <button
          onClick={() => onSelectSection("carrito")}
          className="flex items-center space-x-3 text-gray-300 hover:text-white p-2 rounded-lg hover:bg-gray-700 transition-colors duration-200"
        >
        ...
        {rol === "2" && (
          <button
            onClick={() => onSelectSection("mantenimiento")}
            className="flex items-center space-x-3 text-gray-300 hover:text-white p-2 rounded-lg hover:bg-gray-700 transition-colors duration-200"
          >
