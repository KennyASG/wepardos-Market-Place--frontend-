...
const Navbar = ({ onSearch }) => {
  ...
  return (
    <div ref={navbarRef} className="bg-[#FDD700] p-4 shadow-lg rounded-full mx-4 mt-4 mb-6 flex items-center justify-between font-nunito">
      {/* Logo y Título */}
      <div className="flex items-center ml-6 space-x-2">
        <img src="./Chetah.svg" alt="Logo" className="w-8 h-8 mr-4" />
        <h2 className="text-gray-600 text-2xl font-bold">WepardoStore</h2>
      </div>
